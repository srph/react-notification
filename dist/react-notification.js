(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactNotification"] = factory(require("react"));
	else
		root["ReactNotification"] = factory(root["React"]);
...
var _mitt = __webpack_require__(0);
...
function notify() {
  ...
  emitter.emit.apply(emitter, ['item:add'].concat(args));
}
...
var Notification = exports.Notification = function (_React$Component) {
  ...
  function Notification() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Notification.__proto__ || Object.getPrototypeOf(Notification)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      items: [],
      id: 0
    }, _this.timers = {}, _this.handleAdd = function (opts) {
      opts = _extends({
        timeout: 10000
      }, opts);

      var id = _this.state.id + 1;
      ...
      _this.setState({
        items: [].concat(_toConsumableArray(_this.state.items), [item]),
        id: id
      });
